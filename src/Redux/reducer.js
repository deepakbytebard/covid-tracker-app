import { GET_CONTINENT_DATA, GET_COUNTRY_DATA, GET_CONTINENT_SUCCESS, GET_COUNTRY_SUCCESS, GET_GLOBAL_DATA ,GET_GLOBAL_SUCCESS, GET_WORLD_DATA, GET_WORLD_SUCCESS, GET_COUNTRY_CONTINENT_DATA, GET_COUNTRY_CONTINENT_SUCCESS} from "./action";

const InitialState ={countryData:[], continentData:[], globalData:[], worldData:[], countryContinentData:[]}

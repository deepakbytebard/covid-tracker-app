  ...
  return (
    <div className='main'>
        <div className="sidenav-global">
            <div className="icon"><h1><FaVirus/></h1></div>
     
            <div className='icon-map'><h1><BsMap /></h1>
            ...
            <div className='icon'><h1><MdOutlineDashboard /></h1>DashBoard</div>
            
            <div className='icon'><h1><MdLocalHospital /></h1>Hospital</div>
        </div>
        <div className='container'>
            <div className='topbar'>
                <div>
                    <h3>
                        <FaVirus color="orange" size={30}/> CaronaVirus Covid-10 Global Cases
                        </h3>
                    </div>
            ...
            <div className='main-bottom'>
                ...
                <div className="left-main">
                    ...
                    <div className="row1-global">
                            ...
                            <button className='continent'><Link to="/"> <DiDigitalOcean/> Global</Link></button>

                        </div>
                        <div className='col-global '>
                            <h4 className='confirmed'>Total active</h4>
                            <h3 className='confirmed-number'>{numDifferentiation(active)}</h3>
                            <div className='confirmed-virus'><FaVirus color='red'/></div>
                        </div>
                        <div className='col-global '>
                    ...
                    <div className="row2">
                        ...
                        <div className="right-row2">
                            ...
                            { globals?.map((data)=>{
                                ...
                                return(
                                    <div className="count-continential" onClick={()=>{navigate(`/continent`,{state:{payload:continent}})}}>
